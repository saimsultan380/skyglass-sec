    ...
    <>
      <div className="w-full max-w-none" data-no-reveal>
        <MaskReveal
          ...
          parts={[
            { text: "Contact Sky Glass IPTV and" },
            {
              text: "Request a 24-Hour Trial",
  ...
  return (
    <div className="flex w-full max-w-full min-w-0 flex-col items-stretch gap-2 sm:gap-3 lg:flex-col xl:flex-row xl:items-center">
      ...
      >
        ...
        >
          <CreditCard className="mr-1.5 h-3.5 w-3.5 shrink-0 stroke-[2.5] text-[#E91E8C] sm:mr-2 sm:h-4 sm:w-4" />
