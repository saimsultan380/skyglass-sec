...
const linkClass =
  "text-xs sm:text-sm text-black hover:text-[#E91E8C] font-semibold transition-colors";

export function B1GFooter() {
  return (
    <footer className="w-full bg-white border-t border-slate-200 py-12 sm:py-16 text-black">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-10 border-b border-slate-100">
          <div className="md:col-span-6 flex flex-col items-start gap-4">
            <B1GLogo size="md" />
            <p className="text-xs sm:text-sm text-black font-semibold leading-relaxed max-w-sm">
          ...
          <div className="md:col-span-3">
            <h4 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-black mb-4">
              Navigation
            </h4>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-3">
            ...
            <p className="text-[11px] text-black leading-relaxed max-w-4xl">
